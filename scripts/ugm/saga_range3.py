...
for obj in data:
        ...
        if "curation" in manifests[book]:
            ...
            for member in members:
                ...
                anno = {
                    ...
                    "on": canvas_id+"#xywh="+str(int(areas[0])+int(areas[2]))+","+areas[1]+",1,"+areas[3]
                }
    ...
    ofile = "../../docs/ugm5/"+dir+"/collection.json"
