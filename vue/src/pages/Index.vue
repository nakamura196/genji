<template>
  <div style="width : 100%;">
    ...
    <VueDragResize
      ...
      :x="0 + window_margin"
      :y="window_margin + 50"
      :w="window_width / 2 - window_margin"
      :h="window_height - window_margin"
    ...
    >
      <div class="card">
        <div class="card-body">
          ...
          <small class="mt-2">
            <a target="full" :href="mirador_path" class="mx-2"
              ><span class="fa fa-expand fa-lg fa-fw"></span> 全画面表示</a
            >
          </small>
        </div>
      </div>
    ...
    <VueDragResize
      :isActive="true"
      :x="window_width / 2 + window_margin"
      :y="window_margin + 50"
      :w="window_width / 2 - window_margin * 2"
      :h="window_height / 2"
      v-on:resizing="resize"
      v-on:dragging="resize"
      class="p-2"
    >
      <div
        class="card scroll"
        v-bind:class="{ vertical: direction == 'vertical' }"
        id="org"
      >
        <div class="card-body">
          <h5><b>翻刻文</b></h5>
    ...
    <VueDragResize
      :isActive="true"
      :x="window_width / 2 + window_margin"
      :y="window_height / 2 + window_margin * 2 + 50"
      :w="window_width / 2 - window_margin * 2"
      :h="window_height / 2 - window_margin * 2"
      v-on:resizing="resize"
      v-on:dragging="resize"
      class="p-2"
    >
...
export default {
  ...
  data() {
    return {
      ...
      url_modern:
        "https://nakamura196.github.io/genji/data/aozora/yosano_genji_ids.xml",
  ...
  created: function() {
    ...
    this.iframe_height = this.window_height * this.iframe_percent;
  ...
  methods: {
        ...
        if (this.direction == "vertical") {
          this.$SmoothScroll(
            document.querySelector("#" + modern_ids[0]).getBoundingClientRect()
              ...
              document.querySelector("#modern").getBoundingClientRect().left -
              document.querySelector("#modern").getBoundingClientRect().width /
                2 +
              document
                .querySelector("#" + modern_ids[0])
        ...
        if (this.direction == "vertical") {
          this.$SmoothScroll(
            document.querySelector("#" + modern_ids[0]).getBoundingClientRect()
              ...
              document.querySelector("#org").getBoundingClientRect().left -
              document.querySelector("#org").getBoundingClientRect().width / 2 +
              document
                .querySelector("#" + modern_ids[0])
                .getBoundingClientRect().width,
            400,
    ...
    onResizestop: function(newRect) {
      this.h = newRect.height * this.per;
    }
  }
};
</script>
